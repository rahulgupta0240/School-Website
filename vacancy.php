		...
		<div class="container">
			<div class="w3layouts_breadcrumbs_left">
				<ul>
					...
					<li><i class="fa fa-info-circle" aria-hidden="true"></i>Vacancy</li>
				</ul>
			</div>
...
<!-- about -->
	<div class="welcome">
		<div class="container">
			<h2 class="agileits-title">Vacancy</h2>
...
?>
				<div class="col-md-12 w3_agile_about_grid_left">
					 <div class="col-md-6 dt"> Start Date:-<?php echo ($date); ?></div> 
                     <div class="col-md-6 dt">Last Date:-<?php echo ($date1); ?></div>
